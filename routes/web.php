...
Route::middleware(['auth'])->group(function () {
    ...
    Route::group(['prefix' => 'main/student', 'as' => 'main.student.'], function () {
        ...
        Route::get('/edit-student/{id}', function (Request $request) {
            $selectedStudent = User::find($request->id);
            return view('main.student.edit-student', ['selectedStudent' => $selectedStudent]);
        })->name('edit-student');
    ...
    Route::group(['prefix' => 'main/accountRequest', 'as' => 'main.accountRequest.'], function () {
        Route::get('/requests', function () {
            return view('main.accountRequest.requests');
        })->name('requests');
    ...
    Route::group(['prefix' => 'main/grade', 'as' => 'main.grade.'], function () {
        Route::get('/grades', function () {
            return view('main.grade.grades');
        })->name('grades');

        Route::get('/add-grade', function () {
            return view('main.grade.add-grade');
        })->name('add-grade');


        Route::get('/edit-grade/{id}', function (Request  $request) {

            $selectedGrade = Grade::find($request->id);
            return view('main.grade.edit-grade', ['selectedGrade' => $selectedGrade]);

        })->name('edit-grade');

        Route::get('/grade-details/{id}', function (Request  $request) {

            $selectedGrade = Grade::find($request->id);
            return view('main.grade.grade-details', ['selectedGrade' => $selectedGrade]);
