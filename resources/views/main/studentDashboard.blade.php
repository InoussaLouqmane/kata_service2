                ...
                <div class="card bg-comman w-100">
                    <div class="card-body">
                        <div class="db-widgets d-flex justify-content-between align-items-center">
                            ...
                            <div class="db-icon">
                                <img src="{{asset('/img/icons/teacher-icon-01.svg')}}" alt="Une image">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card bg-comman w-100">
                    <div class="card-body">
                        <div class="db-widgets d-flex justify-content-between align-items-center">
                            ...
                            <div class="db-icon">
                                <img src="{{asset('/img/icons/teacher-icon-02.svg')}}" alt="Une image">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card bg-comman w-100">
                    <div class="card-body">
                        <div class="db-widgets d-flex justify-content-between align-items-center">
                            ...
                            <div class="db-icon">
                                <img src="{{asset('/img/icons/lesson-icon-01.svg')}}">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card bg-comman w-100">
                    <div class="card-body">
                        <div class="db-widgets d-flex justify-content-between align-items-center">
                            ...
                            <div class="db-icon">
                                <img src="{{asset('/img/icons/lesson-icon-02.svg')}}" alt="Une image">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                                ...
                                <div class="dash-details">
                                    <div class="lesson-activity">
                                        <div class="lesson-imgs">
                                            <img src="{{asset('/img/icons/lesson-icon-01.svg')}}" alt="Une image">
                                        </div>
                                    ...
                                    <div class="lesson-activity">
                                        <div class="lesson-imgs">
                                            <img src="{{asset('/img/icons/lesson-icon-03.svg')}}" alt="Une image">
                                        </div>
                                        <div class="views-lesson">
                                            <h5>Time</h5>
                                            <h4>Lessons</h4>
                            ...
                            <div class="col-lg-3 col-md-3">
                                <div class="dash-details">
                                    <div class="lesson-activity">
                                        <div class="lesson-imgs">
                                            <img src="{{asset('/img/icons/lesson-icon-04.svg')}}" alt="Une image">
                                    ...
                                    <div class="lesson-activity">
                                        <div class="lesson-imgs">
                                            <img src="{{asset('/img/icons/lesson-icon-05.svg')}}" alt="Une image">
                                        </div>
                                        <div class="views-lesson">
                                            <h5>Staff</h5>
                                            <h4>John Doe</h4>
                                    ...
                                    <div class="lesson-activity">
                                        <div class="lesson-imgs">
                                            <img src="{{asset('/img/icons/lesson-icon-06.svg')}}" alt="Une image">
                                        </div>
                                        <div class="views-lesson">
