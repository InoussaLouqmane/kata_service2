        ...
        <div id="sidebar-menu" class="sidebar-menu">
            ...
            @if($user->role  === Role::ADMIN)
                <ul>
                    ...
                    <li class=""><a href="{{route('main.adminDashboard')}}" class=""><i class="feather-grid"></i><span> Admin Dashboard</span></a>
                    </li>
            ...
            @elseif($user->role  === Role::SENSEI)
                <ul>
                    ...
                    <li>
                        <a href="{{route('main.teacherDashboard')}}" class="active"><i class="feather-grid"> </i><span> Sensei Dashboard</span></a>
                    </li>
                    ...
                    <li>
                        <a href="{{route('main.event.events')}}"><i class="fas fa-calendar-day"></i> <span>Events</span></a>
                    </li>
                    <li>
                        <a href="{{route('main.timetable.time-table')}}"><i class="fas fa-table"></i>
                            <span>Time Table</span></a>
