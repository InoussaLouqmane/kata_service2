@php use App\Enums\Role;use Illuminate\Support\Facades\Auth;
 $user = Auth::user();
 @endphp
            ...
            <ul>
                <li class="menu-title">
                    <span>Main Menu</span>
                        ...
                        @if($user->role !== Role::ADMIN)
                            ...
                            <li><a href="{{route('main.student.edit-student')}}"><i class="fas fa-clipboard"></i>Student Edit</a></li>
                        @endif
                ...
                <li class="submenu">
                    ...
                    <ul>
                        ...
                        <li><a href="{{route('main.subject.add-subject')}}">Subject Add</a></li>
                        <li><a href="{{route('main.subject.edit-subject')}}">Subject Edit</a></li>
                    </ul>
                </li>
                <li class="submenu">
