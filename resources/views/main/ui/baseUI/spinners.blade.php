            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="mb-4">If you don’t fancy a border spinner, switch to the grow spinner. While it
            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="mb-4">Use spinners within buttons to indicate an action is currently processing or
                            taking place.
